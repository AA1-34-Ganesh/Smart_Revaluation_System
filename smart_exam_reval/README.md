...
git clone https://github.com/AA1-34-Ganesh/Smart_Revaluation_System.git
...
We welcome contributions! Please see our [Contributing Guidelines](CONTRIBUTING.md) and [Database Schema](docs/DATABASE_SCHEMA.md) for details.
